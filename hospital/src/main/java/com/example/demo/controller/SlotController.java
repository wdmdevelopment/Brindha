...
public class SlotController {
	...
	@PostMapping("/slot")
	public ResponseEntity<Slot> saveSlot(@RequestBody RequestSlot reqSlot, long doctorId) {
		logger.info("Slot saved");
		return new ResponseEntity<>(slotService.saveSlot(reqSlot, doctorId), HttpStatus.OK);
